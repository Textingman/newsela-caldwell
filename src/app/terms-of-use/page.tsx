...
export const metadata: Metadata = {
  title: "Terms of Use | Caldwell School District 132",
  description: "Terms of Use for Caldwell School District 132",
};
        ...
        <div className="prose prose-sm max-w-none text-gray-700 space-y-6">
          <section>
            ...
            <p className="leading-relaxed">
              By accessing and using the Caldwell School District 132 website, you accept
          ...
          <section>
            ...
            <p className="leading-relaxed">
              ...
              graphics, logos, images, and software, is the property of Caldwell
              School District 132 and is protected by applicable intellectual property
          ...
          <section>
            ...
            <p className="leading-relaxed">
              ...
              express or implied. Caldwell School District 132 does not warrant that the
          ...
          <section>
            ...
            <p className="leading-relaxed">
              To the fullest extent permitted by law, Caldwell School District 132 shall
          ...
          <section>
            ...
            <p className="leading-relaxed mb-3">
              Caldwell School District 132 uses SMS (text message) communications
            ...
            <p className="leading-relaxed mb-3">
              By opting in to receive SMS messages from Caldwell School District 132, you
            ...
            <p className="leading-relaxed">
              ...
              handled solely by Caldwell School District 132.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="leading-relaxed">
              ...
              are provided for your convenience only. Caldwell School District 132 has no
          ...
          <section>
            ...
            <p className="leading-relaxed">
              ...
              with the laws of the State of Idaho, without regard
          ...
          <section>
            ...
            <div className="mt-3 text-gray-700">
              <p className="font-semibold">Caldwell School District 132</p>
              <p>1200 Grant St</p>
              <p>Caldwell, ID 83605</p>
              <p>
                Email:{" "}
                <a
                  href="mailto:support@caldwellschools132.org"
